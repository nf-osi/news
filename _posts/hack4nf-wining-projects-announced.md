---
title: "Hack4NF Winning Projects Announced"
...
tags: []
ogImage:
  url: "/assets/blog/hack4nf-wining-projects-announced/cover.png"
---

This press release was originally published on the [Children's Tumor Foundation Blog](https://www.ctf.org/news/2022-hack4nf-winning-projects-announced) on November 16, 2022.

* * *

_Hackathon Leveraged Genomic Datasets to Develop Drug Targets, Predict Variants and Correctly Classify Tumors for NF_
...
This is the fourth CTF-hosted hackathon; the first was held in [2019 over 3 days in San Francisco](https://www.ctf.org/news/childrens-tumor-foundation-hosts-nf-innovation-week-in-san-francisco), followed by virtual, multi-week competitions drawing  hundreds of participants across the globe in [2020](https://www.ctf.org/news/patient-participation-nf-hackathon) and [2021](https://www.ctf.org/news/2021-hack4rare-winning-projects-announced).

The 2022 Hack4NF was presented by [Alexion AstraZeneca Rare Disease](https://alexion.com/), [Recursion](https://www.recursion.com/), [SpringWorks Therapeutics](https://springworkstx.com/), and [NTAP](http://www.n-tap.org/) (Neurofibromatosis Therapy Acceleration Program) with cloud support from the [American Heart Association’s Precision Medicine Platform](https://precision.heart.org/), and datasets provided by [Sage Bionetworks](https://sagebionetworks.org/), [NF Data Portal](https://sagebionetworks.org/tools_resources/nf-data-portal/), [NF Open Science Initiative](https://sagebionetworks.org/research-projects/nf-open-science-initiative/), [OpenCRAVAT](https://opencravat.org/), Dr. Rick Van Minkelen, and the [American Association of Cancer Research’s Project GENIE](https://www.aacr.org/professionals/research/aacr-project-genie/).

To learn more about the Hack4NF, [click here](https://hack4nf.bemyapp.com/).

To learn more about the Children’s Tumor Foundation, [click here](http://www.ctf.org/).
